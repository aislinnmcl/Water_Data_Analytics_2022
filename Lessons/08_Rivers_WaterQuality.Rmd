...
NeuseFlow_processed <- NeuseFlow %>%
  ...
  filter(ActivityStartDate >= min(NeuseWQ_processed$ActivityStartDate) & # if joining datasets, makes sense to limit so that they are the same size
